Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/HerenMA/YYWebImage'
  s.platform     = :ios, '6.0'
  ...
  s.frameworks = 'UIKit', 'CoreFoundation', 'QuartzCore', 'AssetsLibrary', 'ImageIO', 'Accelerate', 'CoreServices'
  
  s.dependency 'YYImage', '~> 1.0.5'
